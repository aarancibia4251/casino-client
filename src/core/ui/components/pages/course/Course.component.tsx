...
import SocialProfile from "../../../../../assets/images/background/socialbg.jpg";
  ...
  return (
    <div className="row">
      ...
      <div className="col-lg-4 col-xlg-3 col-md-5">
        <div className="card"><img className="card-img" src={SocialProfile}
                                   alt="Card image" />
          <div className="card-img-overlay card-inverse social-profile d-flex ">
            <div className="align-self-center"><img src={UserImage} className="img-circle"
                                                    width="100" />
      ...
      <div className="col-lg-8 col-xlg-9 col-md-7">
        <div className="card">
          ...
          <ul className="nav nav-tabs profile-tab" role="tablist">
            ...
            <li className="nav-item"><a className="nav-link" data-toggle="tab" role="tab">Profile</a>
            </li>
            <li className="nav-item"><a className="nav-link" data-toggle="tab" role="tab">Settings</a>
            </li>
          </ul>
          ...
          <div className="tab-content">
              ...
              <div className="card-body">
                <div className="profiletimeline">
                  <div className="sl-item">
                    <div className="sl-left"><img src={UserImage} alt="user"
                                                  className="img-circle" /></div>
                    <div className="sl-right">
                      <div><a href="#" className="link">John Doe</a> <span className="sl-date">5 minutes ago</span>
                        <p>assign a new task <a href="#"> Design weblayout</a></p>
                        <div className="row">
                          <div className="col-lg-3 col-md-6 m-b-20"><img src="../assets/images/big/img1.jpg"
                                                                         className="img-responsive radius" /></div>
                          <div className="col-lg-3 col-md-6 m-b-20"><img src="../assets/images/big/img2.jpg"
                                                                         className="img-responsive radius" /></div>
                          <div className="col-lg-3 col-md-6 m-b-20"><img src="../assets/images/big/img3.jpg"
                                                                         className="img-responsive radius" /></div>
                          <div className="col-lg-3 col-md-6 m-b-20"><img src="../assets/images/big/img4.jpg"
                                                                         className="img-responsive radius" /></div>
                        </div>
                        <div className="like-comm"><a href="javascript:void(0)" className="link m-r-10">2 comment</a> <a
                          href="javascript:void(0)" className="link m-r-10"><i
                    ...
                    <div className="sl-right">
                      <div><a href="#" className="link">John Doe</a> <span className="sl-date">5 minutes ago</span>
                        <div className="m-t-20 row">
                          <div className="col-md-3 col-xs-12"><img src="../assets/images/big/img1.jpg" alt="user"
                                                                   className="img-responsive radius" /></div>
                          <div className="col-md-9 col-xs-12">
                            <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent
                              libero. Sed cursus ante dapibus diam. </p> <a href="#" className="btn btn-success"> Design
                            weblayout</a></div>
                        </div>
                        <div className="like-comm m-t-20"><a href="javascript:void(0)" className="link m-r-10">2
                          comment</a> <a href="javascript:void(0)" className="link m-r-10"><i
                          className="fa fa-heart text-danger"></i> 5 Love</a></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="sl-item">
                    ...
                    <div className="sl-right">
                      <div><a href="#" className="link">John Doe</a> <span className="sl-date">5 minutes ago</span>
                        <p className="m-t-10"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec
            ...
            <div className="tab-pane" id="profile" role="tabpanel">
              <div className="card-body">
                ...
                <hr />
                <p className="m-t-30">Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo,
                ...
                <div className="progress">
                  <div className="progress-bar bg-success" role="progressbar" aria-valuenow={80} aria-valuemin={0}
                       aria-valuemax={100} style={{width: '80%', height: '6px'}}><span className="sr-only">50% Complete</span>
                  </div>
                </div>
                <h5 className="m-t-30">Photoshop <span className="pull-right">70%</span></h5>
                <div className="progress">
                  <div className="progress-bar bg-warning" role="progressbar" aria-valuenow={70} aria-valuemin={0}
                       aria-valuemax={100} style={{width: '70%', height: '6px'}}><span className="sr-only">50% Complete</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                <form className="form-horizontal form-material">
                  ...
                  <div className="form-group">
                    ...
                    <div className="col-md-12">
                      <input type="email" placeholder="johnathan@admin.com" className="form-control form-control-line"
